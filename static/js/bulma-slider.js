!function (t, e) {
    ...
    return function (n) {
        ...
        "use strict";
        Object.defineProperty(e, "__esModule", {value: !0}), n.d(e, "isString", function () {
            return l
        });
        var r = n(1), i = Object.assign || function (t) {
        ...
        var l = function (t) {
            ...
            function o(t) {
                ...
                return n._clickEvents = ["click"], n.options = i({}, e), n.onSliderInput = n.onSliderInput.bind(n), n.init(), n
            }
            ...
            return function (t, e) {
                ...
                key: "init", value: function () {
                    if (this._id = "bulmaSlider" + (new Date).getTime() + Math.floor(Math.random() * Math.floor(9999)), this.output = this._findOutputForSlider(), this._bindEvents(), this.output && this.element.classList.contains("has-output-tooltip")) {
                ...
                key: "_findOutputForSlider", value: function () {
                    var e = this, n = null, t = document.getElementsByTagName("output") || [];
                    return Array.from(t).forEach(function (t) {
                        if (t.htmlFor == e.element.getAttribute("id")) return n = t, !0
                    }), n
                }
            }, {
                key: "_getSliderOutputPosition", value: function () {
                    var t, e = window.getComputedStyle(this.element, null),
                ...
                key: "onSliderInput", value: function (t) {
                    if (t.preventDefault(), this.element.classList.contains("has-output-tooltip")) {
                ...
                key: "attach", value: function () {
                    var n = this,
                        ...
                        r = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {}, i = new Array;
        ...
        var i = function () {
            ...
            return r(e, [{
                key: "listenerCount", value: function (t) {
                ...
                key: "middleware", value: function (t, e) {
                    var n = this;
                ...
                key: "emit", value: function (n, r) {
                    var i = this, o = 2 < arguments.length && void 0 !== arguments[2] && arguments[2];
                    n = n.toString();
                    var u = this._listeners.get(n), l = null, a = 0, s = o;
                    if (Array.isArray(u)) for (u.forEach(function (t, e) {
                        o || (l = i._middlewares.get(n), Array.isArray(l) ? (l.forEach(function (t) {
                            t(r, function () {
                                var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : null;
                                null !== t && (r = t), a++
                            }, n)
                        }), a >= l.length && (s = !0)) : s = !0), s && (t.once && (u[e] = null), t.callback(r))
